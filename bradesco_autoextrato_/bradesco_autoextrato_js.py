...
def criar_conexao(link: str) -> webdriver:
    driver = webdriver.PhantomJS(r'C:\Users\vitor\Documents\pahntomjs\phantomjs-2.1.1-windows\bin\phantomjs.exe')
    driver.get(link)
...
def extrai_bradesco(driver: webdriver):
    ...
    menu_select = Select(driver.find_element(By.NAME, "formFiltroUltimosLancamentos:filtro:_id58"))
